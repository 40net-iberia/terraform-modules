USE students;
INSERT INTO `students` (`user_id`, `user_sort`, `server_ip`, `vpc_cidr`, `email`, `access_key`, `secret_key`, `user_password` , `external_id`, `server_test`, `server_check`, `region`, `region_az1`, `accountid`, `cloud9_url`) VALUES
